 ...
 */
@Service
public class MessageServiceImpl extends BaseSerivceImpl<Message> implements MessageService {
    ...
    public boolean sendMail(MessageDTO messageDTO, UserVO userVo) {
        EmailNotification emailNotification = new EmailNotification();
        emailNotification.setContent(messageDTO.getContent());
        emailNotification.setReceiver(userVo.getEmail());
    ...
    public boolean sendSms(MessageDTO messageDTO, UserVO userVo) {
        SmsNotification smsNotification = new SmsNotification();
        smsNotification.setPhoneNumber(userVo.getPhoneNumber());
