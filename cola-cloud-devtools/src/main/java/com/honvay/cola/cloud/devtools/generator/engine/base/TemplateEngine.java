package com.honvay.cola.cloud.devtools.generator.engine.base;

import com.honvay.cola.cloud.framework.util.DateUtils;
import com.honvay.cola.cloud.framework.util.DecimalUtils;
...
public abstract class TemplateEngine extends AbstractTemplateEngine {
    ...
    protected void initBeetlEngine() {
        ...
        groupTemplate.registerFunctionPackage("date", new DateUtils());
        groupTemplate.registerFunctionPackage("decimal", new DecimalUtils());
