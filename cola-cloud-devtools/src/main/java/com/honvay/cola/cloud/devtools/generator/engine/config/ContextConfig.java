...
public class ContextConfig {
    ...
    private String projectPath = "D:\\ideaSpace\\cola";//模板输出的项目目录
    private String bizChName;   //业务名称
    private String bizEnName;   //业务英文名称
    private String bizEnBigName;//业务英文名称(大写)
    private String moduleName = "platform";  //模块名称
    private String bizPath;

    private String proPackage = "";
    private String coreBasePackage = "com.honvay.cola.base.core";
    private String modelPackageName = "com.honvay.cola.admin.modular.system.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.honvay.cola.admin.modular.system.persistence.mapper";  //model的dao
    ...
    public void init() {
        ...
        modelPackageName = proPackage + "." + moduleName + ".entity";
    ...
    public void setBizEnName(String bizEnName) {
        ...
        this.bizEnBigName = StringUtils.capitalize(this.bizEnName);
    }
